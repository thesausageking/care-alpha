...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontWeight: '700', color: light.text, letterSpacing: 0.1 },
  sub: { color: light.subtext, marginTop: 4, lineHeight: 18 },
  list: { flex: 1 },
  ...
  bubbleText: { color: light.text, lineHeight: 19 },
